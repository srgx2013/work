        ...
        "gentleman" =
          home-manager.lib.homeManagerConfiguration {
            ...
            modules = [
              ...
              ./starship.nix  # Starship prompt configurations
              ./nvim.nix  # Neovim configuration
              ./zsh.nix  # Zsh configuration
              {
                # Personal data
                home.username = "saulrosas";  # Replace with your username
                home.homeDirectory = "/Users/saulrosas/";  # Replace with your home directory
